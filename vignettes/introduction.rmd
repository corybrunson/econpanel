...
The opinions are far from uniform, and it's not obvious how to gauge how "far" those on one proposal are from those on another. One way to line up the survey questions according to their responses is a Likert plot, produced here using [the likert package by Jason Bryer](http://jason.bryer.org/likert/):
